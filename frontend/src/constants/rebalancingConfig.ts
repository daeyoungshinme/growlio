...
export const TRIGGER_CONDITION_OPTIONS: { value: TriggerCondition; label: string; desc: string }[] = [
  ...
  { value: "SCHEDULE_ONLY", label: "주기마다 항상", desc: "이탈 여부와 관계없이 주기마다 리포트를 받습니다" },
  { value: "BOTH", label: "주기마다 + 비중 이탈 시", desc: "주기 리포트를 받으면서 이탈 감지 시 즉시 추가 알림 (예수금 포함)" },
];
...
export const MARKET_CONDITION_OPTIONS: { value: MarketConditionMode; label: string; desc: string }[] = [
