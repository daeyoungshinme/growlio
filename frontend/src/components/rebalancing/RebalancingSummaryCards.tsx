    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <div className="bg-gray-800/60 rounded-lg p-2">
          ...
          <div
            className={`text-sm font-semibold ${totalSellSummary > 0 ? LOSS_COLOR : "text-gray-400"}`}
          >
        ...
        <div className="bg-gray-800/60 rounded-lg p-2">
          ...
          <div
            className={`text-sm font-semibold ${totalBuySummary > 0 ? PROFIT_COLOR : "text-gray-400"}`}
          >
