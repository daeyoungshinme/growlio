...
def upgrade() -> None:
    op.add_column("user_settings", sa.Column("auto_dca_enabled", sa.Boolean(), nullable=False, server_default="false"))
    ...
    op.add_column("user_settings", sa.Column("auto_dca_portfolio_id", postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column("user_settings", sa.Column("auto_dca_account_id", postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column("user_settings", sa.Column("auto_dca_last_executed_at", sa.DateTime(timezone=True), nullable=True))
