...
class TestCheckAndTriggerStockPriceAlerts:
    @pytest.mark.asyncio
    async def test_no_alerts_returns_early(self, mock_db, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_price_not_in_map_skips_alert(self, mock_db, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_below_condition_triggers(self, mock_db, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_above_condition_triggers(self, mock_db, mock_redis):
        """ABOVE 조건 충족 시 트리거된다."""
    ...
    @pytest.mark.asyncio
    async def test_alert_deactivated_at_max_trigger(self, mock_db, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_below_condition_not_met_does_not_trigger(self, mock_db, mock_redis):
    ...
    @pytest.mark.asyncio
    async def test_email_failure_skips_alert(self, mock_db, mock_redis):
